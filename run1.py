...
dataloader = DataLoader(data, batch_size=5, collate_fn=collate_fn_padd,shuffle=True, drop_last=True)
test_dataloader = DataLoader(test_data, batch_size=5, collate_fn=collate_fn_padd,shuffle=True, drop_last=True)
model=MyFusionModel().to(device)
...
# model.load_state_dict(torch.load("/home4/khanhnd/pbert/best_checkpoint_10_fusion.pt"))
# Training loop
...
writer = SummaryWriter("/home4/khanhnd/pbert/logs_fusion")
...
for epoch in range(num_epochs):
    ...
    scheduler.step()
    torch.save(model.state_dict(), "/home4/khanhnd/pbert/checkpoint_10_fusion.pt")
    ...
    if val_wer<min_wer:
        ...
        torch.save(model.state_dict(), "/home4/khanhnd/pbert/best_checkpoint_10_fusion.pt")
        min_wer=val_wer
